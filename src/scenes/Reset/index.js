    ...
    return (
      <div className="reset-pwd-wrapper">
        ...
        <form className="reset-form" onSubmit={e => this.handleSubmit(e)}>
          <InputText type="password" id="new-password" placeholder="New Password" onChange={e => this.setState({ password: e.target.value })} />
          <InputText type="password" id="new-password-confirm" placeholder="Confirm new password" onChange={e => this.setState({ confirm: e.target.value })} />
