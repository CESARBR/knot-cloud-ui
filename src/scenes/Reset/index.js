...
class Reset extends Component {
  constructor(props) {
    ...
    this.passwordStatus = this.passwordStatus.bind(this);
  }
  ...
  passwordStatus(isPasswordValid, errorMessage) {
    this.setState({
      isPasswordValid,
      errorMessage
    });
    ...
    return (
      <div className="reset-pwd-wrapper">
        ...
        <form className="reset-form" onSubmit={e => this.handleSubmit(e)}>
          <PasswordInput id="password-input-wrapper" cbPasswordStatus={this.passwordStatus} />
